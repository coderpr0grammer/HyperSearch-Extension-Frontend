...
const LoadingIcon = ({ color, size }) => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" style={{ margin: 0, background: 'transparent', display: 'block', height: 40, }} width={`${size}px`} height={`${size}px`} viewBox="0 0 100 100">
        <circle cx="50" cy="50" r="25" stroke="transparent" stroke-width="10" fill="none"></circle>
        <circle cx="50" cy="50" r="25" stroke={color} stroke-width="8" stroke-linecap="round" fill="none">
